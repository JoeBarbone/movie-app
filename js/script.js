...
var getRatings = function(imdbid) {
    ...
    // fetch("xhttps://imdb-api.com/en/API/Ratings/k_e8wpwz9e/" + imdbid)
    //     .then(function(response) {
    //         return response.json();
    //     })
    //     .then(function(data) {
...
var getDemographicRatings = function(imdbid) {
    // fetch("xhttps://imdb-api.com/en/API/UserRatings/k_e8wpwz9e/" + imdbid)
    //      .then(function(response) {
    //          return response.json();
    //      })
    //      .then(function(data) {
    //          console.log(data);
            ...
            // var agesAllVotes = data.demographicAll.allAges.votes;
            ...
            votesEl.innerHTML = "Votes<br /><br />" + 
                ...
                numberFormatter.format(agesAllVotes);
